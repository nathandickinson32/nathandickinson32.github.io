<template>
    <div class="container">
      <div class="sidebar">
        ...
        <nav>
          <ul>
            <li><router-link to="/"><img src="../assets/images/home.png" alt="Home"/></router-link></li>
            <li><router-link to="/about"><img src="../assets/images/information.png" alt="About"/></router-link></li>
      ...
      <div class="main-content">
        <div class="profile">
          <img src="../assets/images/headshot.png" alt="Nathan Dickinson" />
        </div>
        <div class="info">
