  ...
  <section class="about-me">
    <div class="container">
      ...
      <div class="section">
        ...
        <p class="details">I believe in creating seamless and engaging user experiences. Whether working on a personal project or collaborating with a team, I always strive for excellence, innovation, and collaboration. My goal is to create work that not only meets but exceeds client expectations.</p>
      </div>
